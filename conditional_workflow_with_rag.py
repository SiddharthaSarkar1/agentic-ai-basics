...
def build_retriever(pdf_path: str):
    ...
    return vectorstore.as_retriever(search_kwargs = {"k": 4}) # it will retirn 4 similar chunks


academic_retriever = build_retriever("project3-pdfs/academics_handbook.pdf")
fee_retriever = build_retriever("project3-pdfs/fee_structure.pdf")
...
# Step - 5: Building the Graph and Nodes 
